...
drop table PRD_ADS_PYTHON_NFL_DB.PLAYER;
drop table PRD_ADS_PYTHON_NFL_DB.GAME_STATS;
drop table PRD_ADS_PYTHON_NFL_DB.TEAM_LOOKUP;
drop table PRD_ADS_PYTHON_NFL_DB.GAME_VENUE;
drop table PRD_ADS_PYTHON_NFL_DB.VENUE;
drop table PRD_ADS_PYTHON_NFL_DB.WEATHER;
drop table PRD_ADS_PYTHON_NFL_DB.GAME;
drop table PRD_ADS_PYTHON_NFL_DB.GAME_TYPE;

create table PRD_ADS_PYTHON_NFL_DB.GAME_TYPE (
...
-- GAME_VENUE
create table PRD_ADS_PYTHON_NFL_DB.GAME_VENUE (
  ...
  , CONSTRAINT GAME_VENUE_GAME_ID_FK FOREIGN KEY (GAME_ID)
      REFERENCES PRD_ADS_PYTHON_NFL_DB.GAME (GAME_ID)
  , CONSTRAINT GAME_VENUE_VENUE_ID_FK FOREIGN KEY (VENUE_ID)
      REFERENCES PRD_ADS_PYTHON_NFL_DB.VENUE (VENUE_ID)
)
;

-- VENUE
create table PRD_ADS_PYTHON_NFL_DB.VENUE (
  VENUE_ID INTEGER NOT NULL
...
-- WEATHER
create table PRD_ADS_PYTHON_NFL_DB.WEATHER (
...
-- GAME
create table PRD_ADS_PYTHON_NFL_DB.GAME (
  GAME_ID INTEGER NOT NULL
  , GAME_TYPE_ID INTEGER NOT NULL
  , WEEK INTEGER
  ...
  , CONSTRAINT GAME_GAME_TYPE_ID_FK FOREIGN KEY (GAME_TYPE_ID)
      REFERENCES PRD_ADS_PYTHON_NFL_DB.GAME_TYPE (GAME_TYPE_ID)
)
;

-- GAME_STATS
create table PRD_ADS_PYTHON_NFL_DB.GAME_STATS (
  ...
  , CONSTRAINT GAME_STATS_TEAM_ID_FK FOREIGN KEY (TEAM_ID)
      REFERENCES PRD_ADS_PYTHON_NFL_DB.TEAM_LOOKUP (TEAM_ID)
)
;

-- TEAM_LOOKUP
create table PRD_ADS_PYTHON_NFL_DB.TEAM_LOOKUP (
  TEAM_ID INTEGER NOT NULL
  , TEAM VARCHAR(50)
  , TEAM_SHORT CHAR(3)
  , CONFERENCE CHAR(3)
...
-- PLAYER
create table PRD_ADS_PYTHON_NFL_DB.PLAYER (
